...
public class ExceptionHandlerAdvice {
    ...
    public void addAttributes(Model model) {
        model.addAttribute("msg","xixixihaha"); //3
    }
     ...
     *
     * 2、@ExceptionHandler在此处定义全局处理，通过@ExceptionHandler的value属性可过滤拦截的条件，在此处我们可以看出
     *    我们拦截所有的Exception。
     *
     * 3、此处使用@ModelAttribute注解将键值对添加到全局，对所有注解的@RequestMapping的方法可获得此键值对。
     *
